...
<nav class="navbar">
  ...
  <a class="navbar-brand" style="font-weight: bold; color: #ffffff;" href="index.php">HoosListening</a>
    ...
    <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link active" style="color: white;" aria-current="page" href="logout.php">Log Out</a>
        </li>
    </ul>
  </div>
</nav>
